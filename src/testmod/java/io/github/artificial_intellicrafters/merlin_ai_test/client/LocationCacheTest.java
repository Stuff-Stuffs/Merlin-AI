	...
	public static void init() {
		ClientTickEvents.START.register(client -> {
			if (PATH_KEYBIND.wasPressed()) {
				LAST_PATH = new AIPather(client.cameraEntity, client.world, new TestNodeProducer(client.cameraEntity, client.world, ONE_X_TWO_BASIC_LOCATION_SET_TYPE)).calculatePath(PathTarget.createBlockTarget(10, BlockPos.ORIGIN), 75, true);
				if (LAST_PATH != null) {
