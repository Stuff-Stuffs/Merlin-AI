...
public class MerlinAI implements ModInitializer {
	...
	public static final int PATHING_CHUNK_REMEMBERED_CHANGES = 32;
	public static final int PATHING_CHUNK_CHANGES_BEFORE_RESET = PATHING_CHUNK_REMEMBERED_CHANGES * 6;
	...
	public static AITaskExecutor createExecutor() {
		return new SingleThreadedAITaskExecutor(128);
	}
}
